...
class SiteServicesPage extends StatefulWidget {
  const SiteServicesPage({super.key});

  @override
  State<SiteServicesPage> createState() => _SiteServicesPageState();
}

class _SiteServicesPageState extends State<SiteServicesPage> {
  bool isLoading = true;
  ...
  Future servicesContrated() async {
    ...
    try {
      Response response = await ServicesRepo.getServicesContrated(isSite: true);
                  ...
                  child: Row(
                    ...
                    children: [
                      for (var itemData in item)
                        if (itemData.runtimeType == SiteContratedItem)
                          SiteServiceItemFlex(
                            service: itemData,
                          ),
                    ],
